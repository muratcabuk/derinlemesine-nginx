...
Öncelikle index sayfamıza bir form eklememiz gerekiyor. "_vim /usr/sbin/nginx/html/index.html_" komutu ile dosyamızı editliyoruz. Aşağıdaki form tag'lerini dosyaya eklemeliyiz.


_nginx.config_ dosyamızı "_vim /etc/nginx/nginx.conf_" komutunu çalıştırarak düzenliyoruz. 

- öncelikle global (main) alana dinamik modülü yükemek için "_load_module /usr/lib/nginx/modules/ngx_http_upload_module.so;_" satırını ekliyoruz. 
...
- [Statik modulleri dinamik modüle çevirme](https://www.nginx.com/resources/wiki/extending/converting/)
- [Üçüncü parti modüllerin listesi](https://www.nginx.com/resources/wiki/modules/)