...
- [nginx-vod-module](https://github.com/kaltura/nginx-vod-module): VOD (Video on Demand) yatınları için kullanılır. Nginx'in Plus (paralı) versiyonundaki [ngx_http_hls_module](https://nginx.org/en/docs/http/ngx_http_hls_module.html) moddülünün ücretsiz versiyonudur.
